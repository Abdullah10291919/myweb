...
<body>
    ...
    <!-- =============== START OF WRAPPER =============== -->
    <div class="wrapper">
        <main class="coming-soon" style="background-image: url(<?php echo base_url(); ?>assets/images/posters/movie-collection.jpg)">
            <div class="container">

                <!-- Insert your Logo below -->
                <img src="<?php echo base_url(); ?>assets/images/logo-white.svg" width="200" alt="logo">
