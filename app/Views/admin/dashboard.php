              ...
              <div class="col-xl-4 col-md-6 des-xl-50 box-col-6">
                <div class="card profile-greeting">
                  <div class="card-decore">
                    <div class="main"><img class="img-fluid" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/1.png" alt="Image description"></div>
                ...
                <div class="card dash-chat">
                  ...
                  <div class="card-body">
                    <div class="chat-box dashboard-chat">
                      <div class="chat">
                        <div class="media left-side-chat"><a href="user-profile.html"><img class="rounded-circle chat-user-img img-40 m-r-10" src="<?php echo base_url(); ?>adminassets/assets/images/user/4.jpg" alt=""></a>
                        ...
                        <div class="media right-side-chat">
                          ...
                          </div><a href="user-profile.html"><img class="rounded-circle chat-user-img img-40 m-l-10" src="<?php echo base_url(); ?>adminassets/assets/images/user/5.jpg" alt=""></a>
                        </div>
                        <div class="media m-t-10 left-side-chat"><a href="user-profile.html"><img class="rounded-circle chat-user-img img-40 m-r-10" src="<?php echo base_url(); ?>adminassets/assets/images/user/4.jpg" alt=""></a>
                          <div class="media-body">
                            <div class="message-main">
                    ...
                    <div class="media chat-footer bg-primary"><a href="user-profile.html"><img class="img-fluid imogi" src="<?php echo base_url(); ?>adminassets/assets/images/smiley.png" alt=""></a>
                      <div class="media-body">
                          ...
                          <table class="table table-bordernone">
                            ...
                            <tbody>
                              <tr>
                                <td>01</td>
                                <td>
                                  <div class="t-title d-inline-block align-middle"><a href="user-profile.html"><img class="img-40 m-r-15 rounded-circle align-top" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/p-1.png" alt="" data-original-title="" title=""></a>
                              ...
                              <tr>
                                <td>02</td>
                                <td>
                                  <div class="t-title d-inline-block align-middle"><a href="user-profile.html"><img class="img-40 m-r-15 rounded-circle align-top" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/p-2.png" alt="" data-original-title="" title=""></a>
                                    <div class="status-circle bg-primary"></div>
                              ...
                              <tr>
                                <td>03</td>
                                <td>
                                  <div class="t-title d-inline-block align-middle"><a href="user-profile.html"><img class="img-40 m-r-15 rounded-circle align-top" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/p-3.png" alt="" data-original-title="" title=""></a>
                                    <div class="status-circle bg-primary"></div>
                ...
                <div class="card social-review-sec">
                  ...
                  <div class="card-body p-t-0 p-b-0 social-main">
                    ...
                    <ul class="reviewer-profile">
                      <li><a href="user-profile.html"><img class="rounded-circle" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/social/1.png" alt="Card image cap"></a></li>
                      <li><a href="user-profile.html"><img class="rounded-circle" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/social/2.png" alt="Card image cap"></a></li>
                      <li><a href="user-profile.html"><img class="rounded-circle" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/social/3.png" alt="Card image cap"></a></li>
                      <li><a href="user-profile.html"><img class="rounded-circle" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/social/4.png" alt="Card image cap"></a></li>
                      <li><a href="user-profile.html"><img class="rounded-circle" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/social/5.png" alt="Card image cap"></a></li>
                    </ul>
                  ...
                  <div class="card-body p-0">                              
                    <div class="help-desk text-center">
                      <div class="help-profile">
                        <div class="round-animation"><i></i><i></i></div><img class="img-fluid img-100" src="<?php echo base_url(); ?>adminassets/assets/images/dashboard/mirage-delete.png">
                      </div>
