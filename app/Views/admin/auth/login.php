...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-xl-5"><img class="bg-img-cover bg-center" src="<?php echo base_url(); ?>adminassets/assets/images/login/3.jpg" alt="looginpage"></div>
        <div class="col-xl-7 p-0">
          <div class="login-card">
            <form class="theme-form login-form needs-validation" method="POST" action="<?php echo base_url() ?>admins" novalidate="">
              ...
              <p>Don't have account?<a class="ms-2" href="<?php echo base_url() ?>signup">Create Account</a></p>
            </form>
          </div>
        </div>
      </div>
