...
<html lang="en">
  <head>
    ...
    <title>Movie Admin Template</title>
    <!-- Google font-->
  ...
  <body>
      ...
      <div class="container-fluid p-0"> 
        <div class="row m-0">
          <div class="col-12 p-0">    
            <div class="login-card"><img class="img-fluid bg-img-cover" src="<?php echo base_url(); ?>adminassets/assets/images/login/login_bg.jpg" alt="">
              <form class="theme-form login-form" method="POST" action="<?php echo base_url() ?>signup">
                <div class="login-header text-center">
                  <h4>Create your account</h4>
                  <h6>Enter your personal details to create account</h6>

                  <?php if (session()->has('reponse')): ?>
                  <div class="alert alert-success"><?= session('reponse') ?></div>
              <?php endif; ?>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="small-group">
                    <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                      <input class="form-control" type="text" required="" name="first_name" placeholder="Fist Name">
                    </div>
                    <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                    <input class="form-control" type="text" required="" name="username" placeholder="Enter User Name">
                  </div>
                </div>
                <div class="form-group">
                ...
                <p>Already have an account?<a class="ms-2" href="<?php echo base_url() ?>admins">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>
    ...
    <!-- page-wrapper end-->
    <!-- latest jquery-->
    <script src="<?php echo base_url(); ?>adminassets/assets/js/jquery-3.5.1.min.js"></script>
    <!-- feather icon js-->
    <script src="<?php echo base_url(); ?>adminassets/assets/js/icons/feather-icon/feather.min.js"></script>
    <script src="<?php echo base_url(); ?>adminassets/assets/js/icons/feather-icon/feather-icon.js"></script>
    <!-- Sidebar jquery-->
    <script src="<?php echo base_url(); ?>adminassets/assets/js/sidebar-menu.js"></script>
    <script src="<?php echo base_url(); ?>adminassets/assets/js/config.js">   </script>
    <!-- Bootstrap js-->
    <script src="<?php echo base_url(); ?>adminassets/assets/js/bootstrap/popper.min.js"></script>
    <script src="<?php echo base_url(); ?>adminassets/assets/js/bootstrap/bootstrap.min.js"></script>
    <!-- Plugins JS start-->
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
    <script src="<?php echo base_url(); ?>adminassets/assets/js/script.js"></script>
    <!-- login js-->
    <!-- Plugin used-->
  </body>
</html>