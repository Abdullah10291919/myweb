  ...
  <footer class="footer">
    ...
    <!-- latest jquery-->
    <script src="adminassets/assets/js/jquery-3.5.1.min.js"></script>
    <!-- feather icon js-->
    <script src="adminassets/assets/js/icons/feather-icon/feather.min.js"></script>
    <script src="adminassets/assets/js/icons/feather-icon/feather-icon.js"></script>
    <!-- Sidebar jquery-->
    <script src="adminassets/assets/js/sidebar-menu.js"></script>
    ...
    <script src="adminassets/assets/js/chart/morris-chart/morris.js"> </script>
    <script src="adminassets/assets/js/chart/morris-chart/prettify.min.js"></script>
    <script src="adminassets/assets/js/chart/knob/knob.min.js"></script>
    <script src="adminassets/assets/js/chart/apex-chart/apex-chart.js"></script>
    <script src="adminassets/assets/js/chart/apex-chart/stock-prices.js"></script>
    <script src="adminassets/assets/js/prism/prism.min.js"></script>
    <script src="adminassets/assets/js/clipboard/clipboard.min.js"></script>
    <script src="adminassets/assets/js/counter/jquery.waypoints.min.js"></script>
    ...
    <script src="adminassets/assets/js/script.js"></script>
    <!-- login js-->
    <!-- Plugin used-->
  </body>
</html>